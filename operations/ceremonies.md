...
## Business Case: End-to-End Example

To illustrate how these routines work together in practice, consider a team building a Recommender System feature for an e-commerce platform.
...
With governance routines defined, the next page covers the metrics and success tracking frameworks that measure whether these routines are actually working — from leverage ratios and flow efficiency to the economic metrics that justify the investment in agentic infrastructure.
