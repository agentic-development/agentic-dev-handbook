...
- **Executar Agent Recoveries** — Diagnosticar por que um **agent** travou ensina metodologia de **debugging** em um ambiente de alto volume. Os juniores aprendem a ler rastros de execução, identificar lacunas de **context** e fornecer entrada corretiva.
...
2.  **Mês 3-4:** Assuma a supervisão do **Maintenance Agent**. Tarefas de baixo risco fornecem um ambiente seguro para aprender habilidades de **agent recovery**.
...
-   **Tempo até a supervisão independente** — Quanto tempo leva para um júnior executar **Agent Recoveries** sem a supervisão de um sênior? Meta: 3-4 meses.
...
-   **Taxa de sucesso das Agent Recoveries** — Acompanhe se as **Agent Recoveries** lideradas por juniores resolvem os bloqueios do **agent** na primeira intervenção. Taxas de sucesso crescentes indicam uma crescente habilidade de diagnóstico.
